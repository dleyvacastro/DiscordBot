...
class Moderacion(commands.Cog):
    ...
    @commands.has_any_role(685973595423375388, 849454598296830023)
    async def force_chnick(self, ctx, member: commands.MemberConverter, *, nick):
    ...
    async def zawarudo(self, ctx):
        tts = True
        dio_time = ['Ni', 'San', 'Yon', 'Go',
                    'Roku', 'Nana', 'Hachi', 'Kyuu', 'Jyuu']
        embed = discord.Embed(
        ...
        embed.set_image(
            url='https://media1.tenor.com/images/3546df32c4974a720904643ecf5956ef/tenor.gif?itemid=17040017')
        ...
        try:
            ...
            self.voice.play(discord.FFmpegPCMAudio(
                "./audios/zawarudo.mp3"), after=lambda e: print(f'has finished playing'))
